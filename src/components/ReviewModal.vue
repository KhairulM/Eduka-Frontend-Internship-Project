  ...
  <div id="modal-container">
      <div id="modal-topbar">
          <h3 class="font-color-shade font-light">Review</h3>
            <font-awesome-icon @click="onClickClose" icon="times" style="color: rgba(0, 0, 0, 0.6); cursor: pointer"/>
      </div>
      <div id="answer-container" class="grid-item">
          <div class="answer-unit" v-for="unit in compAnswers" :key="unit.key" ref="answerUnit">
              <div class="answer">
